...
function getGemini(): GoogleGenAI {
  if (!aiInstance) {
    ...
    if (!apiKey) {
      throw new Error("GEMINI_API_KEY is missing. Please provide it in the Environment Variables panel in your Vercel project dashboard.");
    }
...
- If activeMode is "Project Mode": Act as a Project Supervisor. Help with reports, thesis structures, survey reports, presentations, and checklists.`;
    ...
    console.error("Vercel Serverless Function Error calling Gemini API:", err);
